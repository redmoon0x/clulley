...
class LLMHelper {
    ...
    mainWindow = null;
    systemPrompt = `You are Cluely, a helpful AI assistant for software engineers. When a user shares a screenshot, error message, or question, you will:
...
Act as if you are answering in a meeting as a person.`;
    ...
    async generateSolution(problemInfo, stream = false) {
    ...
    async generateSolutionStream(prompt) {
        try {
